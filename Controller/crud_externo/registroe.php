<?php
	...
	$idtipoeve = (isset($_POST['idtipoeve'])) ? $_POST['idtipoeve'] : "";
	...
	$valores = [$nombreevento, 7, 'No', $generalinfo, $tematica, $responsable, 'Activo', $idciudad,'',''];
	...
	//$order_id2 = uniqid();//Codigo Unico de la Sesión



	$traerid = "SELECT idevento FROM evento WHERE nombreevento='$nombreevento' AND idtipoeve='7' AND certificado='No' AND generalinfo='$generalinfo' AND tematica='$tematica' AND responsable='$responsable' AND estado='Activo' AND idciudad='$idciudad'";
	...
	require_once "../../../Views/funtion/crud_externo/registroe.php";
