  <?php
	...
	$valores = [$nombreevento, 6, $certificado, $generalinfo, $tematica, $responsable, 'Activo', $idciudad,$O_tipo,$registro];

	if ($BD->AdicionarRegistro('evento', $campos, $valores)) {
		//echo "<script> alert('Registro Exitoso') </script>";
		$imprimir = "REGISTRO EXITOSO";
		$traerid = "SELECT idevento FROM evento WHERE nombreevento='$nombreevento' AND idtipoeve='6' AND certificado='$certificado' AND generalinfo='$generalinfo' AND tematica='$tematica' AND responsable='$responsable' AND estado='Activo' AND idciudad='$idciudad' AND O_tipo='$O_tipo' AND registro='$registro'";
	...
	require_once "../../../Views/funtion/crud_otro/registroe.php";
