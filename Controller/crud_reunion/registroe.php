   <?php
	...
	$traerid = "SELECT idevento FROM evento WHERE nombreevento='$nombreevento' AND idtipoeve='$idtipoeve' AND certificado='No' AND generalinfo='$generalinfo' AND tematica='$tematica' AND responsable='$responsable' AND estado='Activo' AND idciudad='$idciudad'";
	...
	$valores1 = [$idevento, $nombreevento, $audsalon, $horainicio, $horafin, $fechainicio, $fechainicio, '1'];
