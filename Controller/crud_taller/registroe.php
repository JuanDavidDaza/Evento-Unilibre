...
$BD = new basedatos();
		...
		if ($BD->AdicionarRegistro('evento', $campos, $valores)){
			...
			$traerid="SELECT idevento FROM evento WHERE nombreevento='$nombreevento' AND idtipoeve='3' AND certificado='$certificado' AND generalinfo='$generalinfo' AND tematica='$tematica' AND responsable='$responsable' AND estado='Activo' AND idciudad='$idciudad'";
