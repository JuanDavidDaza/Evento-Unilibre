				...
				if (mysqli_stmt_execute($stmt)) {
					...
					if(mysqli_stmt_num_rows($stmt) == 1){
						...
						if (($tipoevento == "1") || ($tipoevento == "5") ) {
								...
								$valores = [$idasistente,$idevento,$sesion_evento,
										$tipoid,
										$nombre,
										$email,
										$celular,
