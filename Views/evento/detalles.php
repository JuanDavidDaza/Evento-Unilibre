...
<header class="text-center" name="home">
  <div class="container intro-text">
    ...
    <a href="#about-section" class="btn btn-default btn-lg page-scroll">Ver Detalles</a> </div>
</header>
...
<div id="contenido_color">
  ...
  <div class="container">
    <div class="text-center "><h1><span class="color">Sesiones para este Evento</span></h1></div>
