...
<head>
    ...
    <link rel="stylesheet" href="./Views/public/css/viewer.css">
...
<body>
    ...
    <header class="text-center" name="home" data-aos="fade-up">
    ...
    <div id="conferencista" data-aos="fade-up">
        <div class="container">
...
<script src="./Views/public/js/galeria.js"></script>