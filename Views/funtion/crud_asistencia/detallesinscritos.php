...
<div class="container">
	<div class="text-center card border-bottom-danger">
		<div class="text-center">
			...
			<h1 class="display-4 font-weight-bold"><strong>Inscripción al Evento : <?php echo $row1['nombreevento']; ?></strong></h1>
		</div>
		<br>
		<br>
	</div>
...
<div class="container">
	...
	<div class="container">
		<div class="card">
			<h2 class="page-header text-center"><strong> Sesiones Inscritas</strong></h2>
			<hr><br>
