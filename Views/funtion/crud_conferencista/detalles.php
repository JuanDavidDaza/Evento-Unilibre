<div class="container">
  ...
  <div class="text-center card border-bottom-danger">
    <div class=" text-center">
      ...
      <h1 class="display-4 font-weight-bold">Nombre de la Conferencia :</h1>
    ...
    <div class="container">
      <div class="row">
        <?php while ($rowconfe = $confe->fetch_array(MYSQLI_ASSOC)) { ?>
          <div class="col-lg-4 jumbotron card"><img width="100" src="../../../Content/imagenes_conferencistas/<?php echo $rowconfe['foto']; ?>" class="img-responsive img-thumbnail team-img" />
            <div class="caption">
