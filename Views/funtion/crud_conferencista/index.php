		...
		<div class="container">
				<div class="jumbotron">
					...
					<div class="container text-center">
						...
						<h1><strong>Conferencia</strong></h1>
						<div class="row">
							<a href="registro.php"  class="btn btn-primary btn-lg">Nuevo Evento</a>
						</div>
					</div>
				</div>
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr> 
								...
								<td><a href="modificar.php?idevento=<?php echo $row['idevento']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
								<td><a href="detalles.php?idevento=<?php echo $row['idevento']; ?>"><span class="glyphicon glyphicon-search"></span></a></td>
								<td><a href="#" data-href="eliminar.php?idevento=<?php echo $row['idevento']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
