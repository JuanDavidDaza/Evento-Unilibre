		...
		<div class="container">
				...
				<div class="jumbotron">
					<div class="container text-center">
						...
						<h2><strong>Modificar Registro</strong></h2>
						<p>Codigo del Congreso | <span class="label label-info"><?php echo $idevento;?></span></p>
			...
			<form class="form-horizontal" name="contactForm" onsubmit="return validateForm()" method="POST" action="update.php" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="tematica" name="tematica" maxlength="100" minlength="5" placeholder="Nombre" value="<?php echo $row['tematica']; ?>" ><div class="error" id="tematicaErr"></div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="responsable" name="responsable"  maxlength="100" minlength="5" placeholder="Nombre" value="<?php echo $row['responsable']; ?>" ><div class="error" id="responsableErr"></div>
					</div>
...
<div class="container text-center">
		...
		<H3 class="page-header text-center" align="center">Editar Entidades, Sesiones, Colaboradores, Conferencistas, Imagenes y/o Programas que están relacionadas con el Evento</H3>
