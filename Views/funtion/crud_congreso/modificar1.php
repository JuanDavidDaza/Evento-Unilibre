<div class="container">
	...
	<button id="addnew" class="btn btn-dark"><span class="fas fa-plus"></span>Asignar Entidad</button><br>
...
<div class="container text-center jumbotron">
	...
	<h4 class="text-center font-weight-bold">Editar Datos, Conferencistas, Colaboradores, Imagenes y/o Programas del Evento</h4><br>
