		...
		<div class="container">
				...
				<div class="jumbotron">
					<div class="container text-center">
						...
						<h1><strong>Modificar Conferencista del Evento</strong></h1>
						<h3>Nombre de la Congreso | <span class="label label-info"><?php echo $nombreevento;?></span></h3>
					</div>
				</div>
		</div>
<div class="container">
...
<div class="container text-center">
		...
		<H3 class="page-header text-center" align="center">Editar Datos, Sesiones, Programas, Colaboradores, Imagenes y/o Entidades del Evento</H3>
