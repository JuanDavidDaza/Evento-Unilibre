				...
				<form method="POST" name="contactForm" onsubmit="return validateForm()" action="registroe.php">
					...
					<div class="jumbotron">
						<div class="container text-center">
							...
							<h1><strong>Adicionar Congreso</strong></h1>
					...
					<div class="form-group"><label for="tematica">Tema del Evento</label><input type="text" maxlength="50" minlength="5" class="form-control" name="tematica" id="tematica" />
						<div class="error" id="tematicaErr"></div>
					</div>

					<div class="form-group"><label for="responsable">Responsable</label><input type="text" maxlength="50" minlength="5" class="form-control" name="responsable" id="responsable" />
