...
<div class="jumbotron text-center">
	...
	<H3 class="page-header">Clic en siguiente para registrar Conferencistas al Evento</H3>
	<a class="btn btn-dark btn-lg btn-block" href="registro3.php?idevento=<?php echo $row['idevento']; ?>" role="button">SIGUIENTE</a>
