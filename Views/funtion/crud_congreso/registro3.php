<div class="container">
	...
	<div class="text-center card border-bottom-danger">
		<div class=" text-center">
			...
			<h1 class="display-4 font-weight-bold"><strong>Adicionar Conferencistas del Evento</strong></h1>
...
<div class="container">
	...
	<button id="addnew" class="btn btn-dark"><span class="glyphicon glyphicon-plus"></span>Asignar Conferencista</button>
