...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<button id="addnew" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>Asignar Conferencista</button>
...
<div class="container text-center">
		...
		<H3 class="page-header text-center" align="center">Clic en siguiente para registrar Sesiones al Evento</H3>
...
<script src="../../../Views/public/js/appconferencistacong.js"></script>
