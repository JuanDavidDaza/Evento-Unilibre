		...
		<div class="row">
			<div class="jumbotron">
				...
				<div class="container text-center">
					...
					<div class="row">
						<a href="registro.php" class="btn btn-primary">Nueva Entidad</a>
					</div>
				</div>
			</div>
		</div>
				...
				<tbody>
					<?php while ($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
						<tr>
							...
							<td><a href="modificar.php?identidad=<?php echo $row['identidad']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
							<td><a href="#" data-href="eliminar.php?identidad=<?php echo $row['identidad']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
