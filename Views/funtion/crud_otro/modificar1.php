<div class="container">
	...
	<button id="addnew" class="btn btn-dark"><span class="glyphicon glyphicon-plus"></span>Asignar Entidad</button>
...
<div class="container text-center jumbotron">
	...
	<h4 class="text-center font-weight-bold">Editar Datos, Imagenes, Colaboradores y/o Programas del Evento</h4><br>
