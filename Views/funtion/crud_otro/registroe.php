	...
	<div class="text-center card border-bottom-danger">
		...
		<div class="text-center">
			...
			<?php if ($imprimir = "REGISTRO EXITOSO") { ?>
				...
				<h3 class="page-header text-center">A continuación, podrá vincular Programas, Entidades y/o sesiones a su evento,<h4 class="color"><strong><i>Clic en Siguiente para continuar</i></strong></h4>
				</h3>
