		...
		<div class="container">
				<div class="jumbotron">
					...
					<div class="container text-center">
						...
						<div class="row">
							<a href="registro.php" class="btn btn-primary">Nuevo Programa</a>
						</div>
					</div>
				</div>
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr> 
								...
								<td><a href="modificar.php?idprograma=<?php echo $row['idprograma']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
								<td><a href="#" data-href="eliminar.php?idprograma=<?php echo $row['idprograma']; ?>" data-toggle="modal" data-target="#confirm-delete"><span class="glyphicon glyphicon-trash"></span></a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
