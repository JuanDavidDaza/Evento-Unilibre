<div class="container">
	...
	<div class="text-center card border-bottom-danger">
		<div class=" text-center">
			...
			<h1 class="display-4 font-weight-bold"><strong>Asignar Programas al Evento</strong></h1>
	...
	<div class="jumbotron text-center">
		<a class="btn btn-dark btn-lg btn-block" href="registro2.php?idevento=<?php echo $row['idevento']; ?>" role="button">SIGUIENTE</a>
	</div>
