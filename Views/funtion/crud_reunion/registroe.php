			...
			<div class="text-center" style="text-align:center">
				...
				<div class="container text-center">
					<?php if ($imprimir = "REGISTRO EXITOSO") { ?>
						...
						<H3 class="page-header text-center" align="center">A continuación, podrá vincular Programas y/o Entidades a su evento,<h4 class="color"><strong><i>Clic en Siguiente</i></strong></h4>para continuar</H3>
