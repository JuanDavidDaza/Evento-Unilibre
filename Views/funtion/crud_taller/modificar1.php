...
<div class="container"> 
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<button id="addnew" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>Asignar Entidad</button>
...
<div class="container text-center">
		...
		<H3 class="page-header text-center" align="center">Editar Datos, Imagenes, Colaboradores y/o Programas del Evento</H3>
...
<script src="../../../Views/public/js/appentidadtaller.js"></script>
</body>
</html>
