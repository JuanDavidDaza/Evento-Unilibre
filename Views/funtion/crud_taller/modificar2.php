...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			<button id="addnew" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>Asignar Programa</button>
...
<div class="container text-center">
		...
		<H3 class="page-header text-center" align="center">Editar Datos, Imagenes, Sesiones, Colaboradores y/o Entidades del Evento</H3>
