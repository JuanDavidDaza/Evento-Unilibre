...
<div class="container">
	...
	<button id="addnew" class="btn btn-dark"><span class="glyphicon glyphicon-plus"></span>Asignar Programa</button>
...
<div class="container text-center jumbotron">
	...
	<h4 class="text-center font-weight-bold">Editar Datos, Imagenes, Sesiones, Colaboradores y/o Entidades del Evento</h4><br>
