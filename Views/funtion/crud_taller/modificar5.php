...
<div class="container">
	...
	<a href="imagen.php?idevento=<?php echo $row['idevento']; ?>&e=2"  class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>Asignar Imagenes</a>
	<div class="row">
		<div class="col-sm-12">
            </div>  
...
<div class="container text-center">
		...
		<H3 class="page-header text-center" align="center">Editar Datos, Conferencistas, Colaboradores, Sesiones, Programas y/o Entidades del Evento</H3>
