	...
	<div class="container">
		...
		<div class="jumbotron">
			<div class="container text-center">
				...
				<h3>Nombre del Taller | <span class="label label-info"><?php echo $nombreevento; ?></span></h3>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<button id="addnew" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Agregar nuevo</button><br>
		...
		<div class="container text-center">
			...
			<H3 class="page-header text-center" align="center">Registrar Sesiones al Evento</H3>
			<a class="btn btn-success btn-lg btn-block" href="registro4.php?idevento=<?php echo $row['idevento']; ?>" role="button">SIGUIENTE</a>
			<h1></h1>
		...
		<script src="../../../Views/public/js/appprogramataller.js"></script>
</body>
