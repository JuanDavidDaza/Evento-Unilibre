	...
	<body>
		<div class="container">
				...
				<?php if($imprimir="REGISTRO EXITOSO"){ ?>
					<H3 class="page-header text-center" align="center">A continuación, podrá vincular Programas, Entidades y/o sesiones a su evento,<h4 class="color"><strong><i>Clic en Siguiente para continuar</i></strong> </h4></H3>
