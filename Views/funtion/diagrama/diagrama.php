	...
	<body>
		...
		<div class="container">
            ...
            <div class="text-center card border-bottom-danger">
              <hr>
              <h1 class="display-5 font-weight-bold"><strong>Nombre del Evento :<br></strong><?php echo $row['nombreevento']; ?></h1><br> <h2>Ciudad : <span class="badge badge-primary"><?php echo $nombreciudadevento; ?></span></h2><hr><br> 
            </div>
					</div>
				</div>
                  ...
                  <div>
                   ...
                   <?php } ?>
                    ...
                    <div class="card">
                        ...
                        <p>
                        <?php $cont1=0;foreach($resultado2 as $row2){ ?>
                        <div class="card text-center">
                          <header class="alert alert-primary" role="alert"><h4><strong><?php echo $nombre[$cont1]?></strong> || 
                            <i><a><span class="badge badge-secondary">ID: <?php echo $row2['idsesion'];?></span></a></i></h4>
                          </header>
