				...
				<div class="jumbotron">
					<div class="container text-center">
						...
						<div class="text-center card border-bottom-danger"><hr>
							<h1 class="display-4 font-weight-bold"><strong>Reporte por Evento</strong></h1><br><h2>Ciudad : <span class="badge badge-primary"><?php echo $nombreciudadevento; ?></span></h2><hr><br> 
						</div>
					</div>
				</div>
					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr class="text-center"> 
								...
								<td><a class="btn btn-primary" href="diagrama.php?idevento=<?php echo $row['idevento']; ?>">Ir</a></td>
							</tr>
						<?php } ?>
					</tbody>
				</table>
