				...
				<div class="jumbotron">
					<div class="container text-center">
						...
						<div class="text-center card border-bottom-danger"><hr>
							<h1 class="display-4 font-weight-bold"><strong>Reporte por Conferencista</strong></h1><br><h2>Ciudad : <span class="badge badge-primary"><?php echo $nombreciudadevento; ?></span></h2><hr><br> 
						</div>
					</div>
				</div>
