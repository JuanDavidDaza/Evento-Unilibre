		...
		<div class="jumbotron">
			<div class="container text-center ">
				...
				<div class="text-center card border-bottom-danger">
					<hr>
					<h1 class="display-5 font-weight-bold"><strong>Nombre del Evento: </strong><br> <?php echo $row1['nombreevento']; ?></h1><br>
					<h3>Nombre de la Sesión <span class="badge badge-primary"><?php echo $nombredesesion; ?></span></h3>
					<br>
					<hr>
