...
<html lang="es">
  <head>
    ...
    <title>Reporte <?php echo $fechaActual." || ".$row1['nombreevento'] ." || Sesión: ". $row3['nombresesion'] ;?></title>
		...
		<div class="container">
				<div class="jumbotron">
					<div class="container text-center ">
						...
						<div class="text-center card border-bottom-danger"><hr>
							<h1 class="display-5 font-weight-bold"><strong>Nombre del Evento: </strong><br> <?php echo $row1['nombreevento']; ?></h1><br><h3>Nombre de la Sesión <span class="badge badge-primary"><?php echo $nombredesesion; ?></span></h3>
						<br><hr><h2>Ciudad : <span class="badge badge-info"><?php echo $nombreciudadevento; ?></span></h2><hr>
						</div><br>
