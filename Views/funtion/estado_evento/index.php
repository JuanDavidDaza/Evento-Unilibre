...
<hr>
	<div class="jumbotron">
		<ul><p>Cambiar el estado de los Eventos por <strong>Cerrado</strong>,donde las sesiones esten en estado <strong>Finalizado</strong></p><button type="button" name="registro" class="button btn-danger btn-lg registro " data-user_id="<?php echo $idciudad; ?>">Clic Aqui para Registrar</button></ul>
	</div>
	<hr>	
