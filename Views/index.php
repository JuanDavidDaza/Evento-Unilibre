...
<div >
  <div class=" jumbotron text-center" data-aos="fade-down">
    <div  class="row jumbotron eventofiltro"  style="justify-content: center; "  >
      ...
      <div class="search" >
                    <input type="text" class="search-input " placeholder="Buscar eventos o categorias" id="buscar" name="buscar" onkeyup="buscar_ajax(this.value);"> <a class="search-icon"> <i class="fa fa-search"></i> </a>  </div>
