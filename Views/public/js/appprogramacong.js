...
fetch();
	...
	$('#addForm2').submit(function(e){
		...
		$.ajax({
			method: 'POST',
			url: '../../../Controller/crud_congreso/funcmodal/programa/add.php',
			data: addform,
			dataType: 'json',
	...
	$('.id').click(function(){
		...
		$.ajax({
			method: 'POST', 
			url: '../../../Controller/crud_congreso/funcmodal/programa/delete.php',
			data: {id:id},
			dataType: 'json',
			success: function(response){
				if(response.error){
...
function fetch(){
	$.ajax({
		method: 'POST',
		url: '../../../Controller/crud_congreso/funcmodal/programa/fetch.php',
...
function getDetails(id){
	$.ajax({
		method: 'POST',
		url: '../../../Controller/crud_congreso/funcmodal/programa/fetch_row.php',
		data: {id:id},
		dataType: 'json',
		success: function(response){
			if(response.error){
