$(document).ready(function () {
  ...
  $("#addForm3").submit(function (e) {
    ...
    $.ajax({
      method: "POST",
      url: "../../../Controller/crud_congreso/funcmodal/sesiones/add.php",
      data: addform,
      dataType: "json",
  ...
  $(".id").click(function () {
    ...
    $.ajax({
      method: "POST",
      url: "../../../Controller/crud_congreso/funcmodal/sesiones/delete.php",
      data: { id: id },
      dataType: "json",
      success: function (response) {
        if (response.error) {
...
$("#editForm").submit(function (e) {
  ...
  $.ajax({
    method: "POST",
    url: "../../../Controller/crud_congreso/funcmodal/sesiones/edit.php",
    data: editform,
    dataType: "json",
    success: function (response) {
      if (response.error) {
...
function fetch() {
  $.ajax({
    method: "POST",
    url: "../../../Controller/crud_congreso/funcmodal/sesiones/fetch.php",
...
function getDetails(id) {
  $.ajax({
    method: "POST",
    url: "../../../Controller/crud_congreso/funcmodal/sesiones/fetch_row.php",
    data: { id: id },
    dataType: "json",
    success: function (response) {
      if (response.error) {
