...
fetch();
	...
	$('#addForm3').submit(function(e){
		...
		$.ajax({
			method: 'POST',
			url: '../../../Controller/crud_taller/funcmodal/sesiones/add.php',
			data: addform,
			dataType: 'json',
	...
	$('.id').click(function(){
		...
		$.ajax({
			method: 'POST', 
			url: '../../../Controller/crud_taller/funcmodal/sesiones/delete.php',
			data: {id:id},
			dataType: 'json',
			success: function(response){
				if(response.error){
  ...
  $(document).on('click', '.edit', function(){
	...
	$('#editForm').submit(function(e){
		...
		$.ajax({
			method: 'POST',
			url: '../../../Controller/crud_taller/funcmodal/sesiones/edit.php',
			data: editform,
			dataType: 'json',
			success: function(response){
				if(response.error){
...
function fetch(){
	$.ajax({
		method: 'POST',
		url: '../../../Controller/crud_taller/funcmodal/sesiones/fetch.php',
...
function getDetails(id){
	$.ajax({
		method: 'POST',
		url: '../../../Controller/crud_taller/funcmodal/sesiones/fetch_row.php',
		data: {id:id},
		dataType: 'json',
		success: function(response){
			if(response.error){
