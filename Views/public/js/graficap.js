  ...
  $.ajax({
    ...
    if (resp.length>0) {
        ...
        //alert(titulo);
        CrearGrafico2(titulo,cantidad,colores,'doughnut','Grafico','Conferencista');
...
Programas();
  ...
  $.ajax({
    ...
    if (resp.length>0) {
        ...
        CrearGrafico2(titulo,cantidad,colores,'doughnut','Grafico','Programas');
        //document.getElementById("grafico").style.display = "none";
        //document.getElementById("grafico2").style.display = "block";
...
Entidades();
  ...
  $.ajax({
    ...
    if (resp.length>0) {
        ...
        CrearGrafico2(titulo,cantidad,colores,'doughnut','Grafico','Entidades');
        //document.getElementById("grafico").style.display = "none";
        //document.getElementById("grafico2").style.display = "block";
  ...
  $.ajax({
    ...
    if (resp.length>0) {
        ...
        CrearGrafico2(titulo,cantidad,colores,'doughnut','Grafico','graficopie');
        //document.getElementById("grafico").style.display = "none";
        //document.getElementById("grafico2").style.display = "block";
...
CargarDatosGraficosPie1();
  ...
  $.ajax({
    ...
    if (resp.length>0) { 
        ...
        CrearGrafico2(titulo,cantidad,colores,'doughnut','Grafico','graficopie1');
        //document.getElementById("grafico").style.display = "none";
        //document.getElementById("grafico2").style.display = "block";
...
CargarDatosGraficosPie2();
  ...
  $.ajax({
    ...
    if (resp.length>0) {
        ...
        CrearGrafico2(titulo,cantidad,colores,'doughnut','Grafico','graficopie2');
        //document.getElementById("grafico").style.display = "none";
        //document.getElementById("grafico2").style.display = "block";
...
CargarDatosGraficosPie3();
  ...
  $.ajax({
    ...
    if (resp.length>0) {
        ...
        CrearGrafico2(titulo,cantidad,colores,'doughnut','Grafico','graficopie3');
        //document.getElementById("grafico").style.display = "none";
        //document.getElementById("grafico2").style.display = "block";
