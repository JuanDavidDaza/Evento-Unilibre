...
function validateForm(){ 
    ...
    //var horafin = document.contactForm.horafin.value;
    var fechainicio = document.contactForm.fechainicio.value;
    var fechafin = document.contactForm.fechafin.value;

    
    var nombreeventoErr = generalinfoErr= tematicaErr = responsableErr = audsalonErr= fechainicioErr= fechafinErr=true;
   ...
   if(nombreevento == "") {
    ...
    if(tematica == "") {
        ...
        if(regex.test(tematica) === false) {
            printError("tematicaErr", "Por favor ingrese una tematica valida y con Max 50 letras");
        } else {
    ...
    if(responsable == "") {
        ...
        if(regex.test(responsable) === false) {
            printError("responsableErr", "Por favor ingrese un Responsable valido y con Max 50 letras");
        } else {
    ...
    if(audsalon == "") {
        ...
        var regex = /^[ A-Za-zäÄëËïÏöÖüÜáéíóúáéíóúÁÉÍÓÚÂÊÎÔÛâêîôûàèìòùÀÈÌÒÙ1234567890ñÑ.:/-]{5,70}$/;
        //var regex = /^[a-zA-áéíóúñüàè]{5,50}$/;
        if(regex.test(audsalon) === false) {
            printError("audsalonErr", "Por favor ingrese un lugar valido y con Max 50 letras");
        } else {
...
/*
        if (horainicio=='') {
            printError("horainicioErr", "Por favor ingrese una Hora Inicio");
                ...
                if (horainicio.length!=8) {
                    printError("horainicioErr", "Por favor ingrese una Hora Valida");
                    horainicioErr = false;
                }
                ...
                if (c!=':') {
                    printError("horainicioErr", "Introducir HH:MM:SS 2");
                    horainicioErr = false;
                }
        ...
        if (horafin=='') {
            printError("horafinErr", "Por favor ingrese una Hora Inicio");
        }else{
                if (horafin.length>8) {
                    printError("horafinErr", "Introdujo una cadena mayor a 8 caracteres");
                    horafinErr = false;
                }
                if (horafin.length!=8 || horafin.length!=5) {
                    printError("horafinErr", "Por favor ingrese una Hora Valida");
                    horafinErr = false;
                }
    ...
    if ((nombreeventoErr  || generalinfoErr || tematicaErr  || responsableErr  || audsalonErr || fechainicioErr || fechafinErr ) == true) {
        return false;
    } else {
