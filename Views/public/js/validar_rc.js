...
function validateForm(){ 
   ...
   // var horafin = document.contactForm.horafin.value; horainicioErr=horafinErr=
    ...
    var nombreeventoErr = generalinfoErr= tematicaErr = responsableErr  = audsalonErr = fechainicioErr =  true;
...
*/
    ...
    if ((nombreeventoErr  || generalinfoErr || tematicaErr  || responsableErr || audsalonErr  || fechainicioErr  ) == true) {
        return false;
    } else {
